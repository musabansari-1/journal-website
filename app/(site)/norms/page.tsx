...
export default function NormsPage() {
  return (<><Navbar /><main className="pt-16">
    ...
    <div className="max-w-4xl mx-auto px-4 py-16 space-y-8">
      {[{t:'Scope and Coverage',c:'Elsevier Multidisciplinary International Research Journal accepts original research papers, review articles, case studies, and short communications from all academic disciplines including but not limited to Sciences, Social Sciences, Humanities, Engineering, Law, Management, and Education.'},
