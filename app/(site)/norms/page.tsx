...
export default function NormsPage() {
  return (<><Navbar /><main className="pt-16">
    <div className="bg-gradient-to-br from-brand-900 to-brand-800 py-16 text-center"><h1 className="font-display text-4xl font-bold text-white mb-3">Publication Norms</h1><p className="font-body text-brand-200">Standards and norms for publication in Nrityanjali Research Journal</p></div>
    <div className="max-w-4xl mx-auto px-4 py-16 space-y-8">
      {[{t:'Scope and Coverage',c:'Nrityanjali Multidisciplinary International Research Journal (E-ISSN: 3108-1452) accepts original research papers, review articles, case studies, and short communications from all academic disciplines including but not limited to Sciences, Social Sciences, Humanities, Engineering, Law, Management, and Education.'},
        ...
        {t:'Copyright',c:'Authors retain copyright of their work. By submitting, authors grant Nrityanjali Journal the right to publish and distribute the paper. The journal publishes under Creative Commons Attribution 4.0 International License (CC BY 4.0).'},
