...
const FALLBACK_MEMBERS: Member[] = [
  { id: '1', name: 'Dr. Mahesh Kumar Arya', designation: 'Assistant Professor & M.A., M.Ed., M.Phil, Ph.D.', institute: 'Dr. B.R.A University, Agra', country: 'India', expertise: 'Education', type: 'reviewer', email: 'rudraarya1411@gmail.com' },
]
...
export default function BoardPage() {
  ...
  useEffect(() => {
    fetch(apiUrl('/api/members/reviewer'))
      .then(r => r.json())
  ...
  return (
    <><Navbar /><main className="pt-16">
      <div className="bg-gradient-to-br from-brand-900 to-brand-800 py-16 text-center">
        <h1 className="font-display text-4xl font-bold text-white mb-3">Reviewer Committee</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center gap-3 mb-5">
          <h2 className="font-display text-xl font-bold text-brand-900">Reviewer Committee</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
            ...
            <p className="font-display text-xl text-gray-400 mb-2">No Committee Members Found for Reviewer Committee</p>
              ...
              <div key={m.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-brand-200 hover:shadow-md transition-all overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-sans text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-100 border border-emerald-200 px-3 py-1 rounded-full">Reviewer Committee</span>
