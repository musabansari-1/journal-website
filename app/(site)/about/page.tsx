...
export default function AboutPage() {
  return (<><Navbar /><main className="pt-16">
    <div className="bg-gradient-to-br from-brand-900 to-brand-800 py-20 text-center">
      ...
      <p className="font-body text-brand-200 text-lg max-w-2xl mx-auto">Nrityanjali Multidisciplinary International Research Journal — peer-reviewed, open access, globally accessible.</p>
    </div>
    <section className="py-20 bg-white max-w-4xl mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div><h2 className="font-display text-3xl font-bold text-brand-900 mb-4">About the Journal</h2><p className="font-body text-gray-700 leading-relaxed mb-4">Nrityanjali Multidisciplinary International Research Journal (E-ISSN: 3108-1452) is a peer-reviewed, open-access journal published by Nrityanjali India (OPC) Private Limited.</p><p className="font-body text-gray-700 leading-relaxed">We are committed to promoting original research, critical reviews, and scholarly contributions across all academic disciplines.</p></div>
        <div className="grid grid-cols-2 gap-4">{[['E-ISSN','3108-1452'],['Founded','2024'],['Access','Open Access'],['Review','Double Blind Peer Review']].map(([k,v])=><div key={k} className="bg-brand-50 rounded-2xl p-5 text-center"><div className="font-sans text-xs text-brand-500 mb-1">{k}</div><div className="font-display text-lg font-bold text-brand-900">{v}</div></div>)}</div>
      </div>
